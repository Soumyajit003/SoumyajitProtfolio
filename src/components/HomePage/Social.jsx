    ...
    <>
      <Element name="connect" className=" font-outfit md:mx-25  md:hidden block mx-10 mt-10 pb-5 border-b border-b-zinc-600">
        <motion.p
          ...
          className="font-outfit text-3xl m-auto text-center my-5 cursor-default text-white"
        >
          Connect with me
        </motion.p>
        ...
        <div className=" text-yellow-400 my-4">
          ...
          >
            ...
            <a
              href="https://www.linkedin.com/in/berasoumyajit/"
              className=" hover:text-white transition duration-200 mx-2 cursor-pointer"
              target="_blank"
            >
              <span className="[&>svg]:h-5 [&>svg]:w-4">
            ...
            <a
              href="https://x.com/SoumyajitBera18"
              className=" hover:text-white transition duration-200 mx-2 cursor-pointer"
              target="_blank"
            >
              <span className="[&>svg]:h-5 [&>svg]:w-4">
